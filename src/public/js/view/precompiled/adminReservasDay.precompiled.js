...
templates['adminReservasDay.hbs'] = template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "<div class=\"asr__citas__itemContainer\" data-serviceID="
    ...
    + alias4(((helper = (helper = lookupProperty(helpers,"comments") || (depth0 != null ? lookupProperty(depth0,"comments") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"comments","hash":{},"data":data,"loc":{"start":{"line":31,"column":49},"end":{"line":31,"column":61}}}) : helper)))
    + "</textarea>\r\n            </div>\r\n            <div class=\"asr__citas__item__details__pushNotification\">\r\n                <p>Notifiación Push</p>\r\n                <textarea class=\"asr__textarea__pushNotification\" name=\"\" id=\"\"\r\n                    placeholder=\"Escriba mensaje para enviar notifiación al cliente\"></textarea>\r\n                <button class=\"asr__btn__send__notification\" data-userID="
    + alias4(((helper = (helper = lookupProperty(helpers,"userID") || (depth0 != null ? lookupProperty(depth0,"userID") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"userID","hash":{},"data":data,"loc":{"start":{"line":37,"column":73},"end":{"line":37,"column":83}}}) : helper)))
    + ">Enviar Notificacion</button>\r\n            </div>\r\n            <div class=\"asr__citas__item__details__buttons\">\r\n                <button>Borrar Cita</button>\r\n                <button>Modificar Cita</button>\r\n            </div>\r\n            <div class=\"asr__citas__item__showLessDetails\">\r\n                <i class=\"icon-double-up\"></i>\r\n            </div>\r\n\r\n        </div>\r\n    </div>\r\n\r\n</div>\r\n";
  ...
  return ((stack1 = lookupProperty(helpers,"each").call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? lookupProperty(depth0,"reserva") : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 0),"inverse":container.noop,"data":data,"loc":{"start":{"line":1,"column":0},"end":{"line":51,"column":9}}})) != null ? stack1 : "");
},"useData":true});
})();