...
templates['adminReservasDay.hbs'] = template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "<div class=\"asr__citas__itemContainer\" data-serviceID="
    ...
    + alias4(((helper = (helper = lookupProperty(helpers,"comments") || (depth0 != null ? lookupProperty(depth0,"comments") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"comments","hash":{},"data":data,"loc":{"start":{"line":40,"column":49},"end":{"line":40,"column":61}}}) : helper)))
    ...
    + alias4(((helper = (helper = lookupProperty(helpers,"userID") || (depth0 != null ? lookupProperty(depth0,"userID") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"userID","hash":{},"data":data,"loc":{"start":{"line":48,"column":36},"end":{"line":48,"column":46}}}) : helper)))
    ...
    + alias4(((helper = (helper = lookupProperty(helpers,"reservationID") || (depth0 != null ? lookupProperty(depth0,"reservationID") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"reservationID","hash":{},"data":data,"loc":{"start":{"line":56,"column":40},"end":{"line":56,"column":57}}}) : helper)))
    ...
    + alias4(((helper = (helper = lookupProperty(helpers,"date") || (depth0 != null ? lookupProperty(depth0,"date") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"date","hash":{},"data":data,"loc":{"start":{"line":59,"column":87},"end":{"line":59,"column":95}}}) : helper)))
  ...
  return ((stack1 = lookupProperty(helpers,"each").call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? lookupProperty(depth0,"reserva") : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 0),"inverse":container.noop,"data":data,"loc":{"start":{"line":1,"column":0},"end":{"line":70,"column":9}}})) != null ? stack1 : "");
},"useData":true});
})();