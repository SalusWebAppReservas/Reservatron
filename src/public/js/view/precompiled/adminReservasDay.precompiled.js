...
templates['adminReservasDay.hbs'] = template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "<div class=\"asr__citas__itemContainer\" data-serviceID="
    ...
    + "\"' data-userEmail='\""
    + alias4(((helper = (helper = lookupProperty(helpers,"userEmail") || (depth0 != null ? lookupProperty(depth0,"userEmail") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"userEmail","hash":{},"data":data,"loc":{"start":{"line":34,"column":74},"end":{"line":34,"column":87}}}) : helper)))
    + "\"'\r\n                        data-created='\""
    + alias4(((helper = (helper = lookupProperty(helpers,"created") || (depth0 != null ? lookupProperty(depth0,"created") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"created","hash":{},"data":data,"loc":{"start":{"line":35,"column":39},"end":{"line":35,"column":50}}}) : helper)))
    ...
    + alias4(((helper = (helper = lookupProperty(helpers,"comments") || (depth0 != null ? lookupProperty(depth0,"comments") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"comments","hash":{},"data":data,"loc":{"start":{"line":44,"column":49},"end":{"line":44,"column":61}}}) : helper)))
    ...
    + alias4(((helper = (helper = lookupProperty(helpers,"userID") || (depth0 != null ? lookupProperty(depth0,"userID") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"userID","hash":{},"data":data,"loc":{"start":{"line":52,"column":36},"end":{"line":52,"column":46}}}) : helper)))
    + ">Enviar\r\n                        push</button>\r\n                    <button class=\"asr__btn__send__notification asr__citas__item__buttonEmail\"\r\n                        data-userID="
    + alias4(((helper = (helper = lookupProperty(helpers,"userID") || (depth0 != null ? lookupProperty(depth0,"userID") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"userID","hash":{},"data":data,"loc":{"start":{"line":55,"column":36},"end":{"line":55,"column":46}}}) : helper)))
    + ">Enviar email</button>\r\n                </div>\r\n            </div>\r\n            <div class=\"asr__citas__item__details__buttons__crud\">\r\n                <button class=\"idButtonsDeleteModify asr__citas__item__buttonDelete\"\r\n                    data-reservation_id="
    + alias4(((helper = (helper = lookupProperty(helpers,"reservationID") || (depth0 != null ? lookupProperty(depth0,"reservationID") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"reservationID","hash":{},"data":data,"loc":{"start":{"line":60,"column":40},"end":{"line":60,"column":57}}}) : helper)))
    + " data-name=\"delete\">Borrar\r\n                    Reserva</button>\r\n                <button class=\"idButtonsDeleteModify asr__citas__item__buttonModify\"\r\n                    data-reservation_id="
    + alias4(((helper = (helper = lookupProperty(helpers,"reservationID") || (depth0 != null ? lookupProperty(depth0,"reservationID") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"reservationID","hash":{},"data":data,"loc":{"start":{"line":63,"column":40},"end":{"line":63,"column":57}}}) : helper)))
    + " data-name=\"modify\" data-date="
    + alias4(((helper = (helper = lookupProperty(helpers,"date") || (depth0 != null ? lookupProperty(depth0,"date") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"date","hash":{},"data":data,"loc":{"start":{"line":63,"column":87},"end":{"line":63,"column":95}}}) : helper)))
  ...
  return ((stack1 = lookupProperty(helpers,"each").call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? lookupProperty(depth0,"reserva") : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 0),"inverse":container.noop,"data":data,"loc":{"start":{"line":1,"column":0},"end":{"line":74,"column":9}}})) != null ? stack1 : "");
},"useData":true});
})();